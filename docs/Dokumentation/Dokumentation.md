...
Zum Schluss wird eine finale PDF erstellt. Diese enthält das Bild im Hintergrund und den erkannten Text in einem Overlay darüber. So kann im Hintergrund ein Wort mit einem PDF Reader markiert werden, wodurch tatsächlich das Wort im Overlay ausgewählt wird.
